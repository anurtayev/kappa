...
export =$(aws cloudformation describe-stacks --stack-name epsilon-development-092347820172-us-east-1-app --query 'Stacks[0].Outputs[?OutputKey==`CloudFrontDistributionUrl`].OutputValue | [0]' --output text)
